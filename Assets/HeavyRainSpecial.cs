...
//Drops items from player
public class HeavyRainSpecial : MonoBehaviour {
	...
	void Start () {
        ...
        indicator.GetComponent<DamageDisplayText>().value = "PENALTY";
    ...
    public Item IndexToItem(int index)
    {
        switch (index)
        {
            ...
            default: Debug.Log("Error. Invalid item to decrease from Heavy Rain.");
                break;
        }
        return Item.Void;
    }
